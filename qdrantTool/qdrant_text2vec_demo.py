...
csv_path = os.getenv('CSV_PATH', '/workspace/test.csv')
workspace = os.getenv('WORKSPACE', '/workspace')
client = QdrantClient("192.168.0.253", port=6333, timeout=3600)
text2vec_url = os.getenv('TEXT2VEC_URL', 'http://127.0.0.1:13100/text2vec')
...
if __name__ == '__main__':
    ...
    vectorize_data()
    cleand_article_list = clean_work_data()
    upsert_articles(cleand_article_list)
    print('vectorize data success')
    # 记录总耗时
    end_time = time.time()
